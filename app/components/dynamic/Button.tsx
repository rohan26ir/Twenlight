...
const Button: React.FC<ButtonProps> = ({ buttonInfo }) => {
  ...
  const baseStyles = 'inline-flex items-center justify-center font-medium rounded-3xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2';

  const variantStyles = {
    primary: 'bg-[#C3F499] text-black hover:bg-black hover:text-white focus:ring-blue-500 active:bg-blue-800',
